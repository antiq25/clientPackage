  ...
  return (
    <Card>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>Rating: {selectedReview?.stars}</DialogContentText>
          <DialogContentText>Date: {selectedReview?.date}</DialogContentText>
          <DialogContentText>Review: {selectedReview?.fullReview}</DialogContentText>
        </DialogContent>
        <DialogActions>
