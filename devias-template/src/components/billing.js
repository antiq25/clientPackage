...
const PlanCard = ({ plan }) => {
    ...
    return (
        <Paper elevation={3} style={{
            ...
            {plan.popular && <Box style={{ position: 'absolute', top: 0, right: 0, backgroundColor: '#cea528', padding: '5px 10px' }}>
                POPULAR
            </Box>}
            <Card>
                <CardHeader
                ...
                <Container style={{
                    ...
                    alignItems: 'center', margin: '0px 0px 40px 0px'
                }}>
                    <Box style={{ display: 'flex', alignItems: 'baseline' }}>
                        <Typography variant="h4">$</Typography>
                        <Typography variant="h2">{plan.price}</Typography><Typography variant="h6">Month</Typography>
                    </Box>
        ...
        <Card>
            <Box textAlign="center" paddingY={4}>
                ...
                <Typography variant="subtitle2">
                    After your 7-day FREE Trial – you will be automatically charged according to the plan you select. If you require more than 10 business listings, please Contact Us Here.
                </Typography>
            </Box>
            ...
            <Grid container sx={{justifyContent: 'center', paddingBottom: '10px'}}> 
                {plans.map(plan => (
                    ...
                    <Grid item key={plan.title} display='flex' justifyContent="center" xs={12} sm={6} md={4}> 
                        <PlanCard plan={plan} />
                    </Grid>
                ))}
            </Grid>
