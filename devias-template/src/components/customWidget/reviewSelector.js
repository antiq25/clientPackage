    ...
    const columns = [
        {
            ...
            renderCell: (params) => (
                params.value ?
                    <img src={params.value} alt="User" style={{ height: 40, width: 40, borderRadius: '50%' }} /> :
        ...
        { field: 'stars', headerName: 'Rating', flex: 1 },
        {
            ...
            renderCell: (params) => (
                <Tooltip title={params.value}>
                    <Typography style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '80%' }}>
                        {params.value}
                    </Typography>
                </Tooltip>
            )
    ...
    return (
        <Card sx={{ height: 390 }}>
            ...
            {isLoading ? (
                ...
                <Typography variant="body1" color="textSecondary">No reviews available for this listing.</Typography>
            )}
        </Card>
    );
};
