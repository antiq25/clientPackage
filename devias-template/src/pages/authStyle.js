      ...
      >
        <Box maxWidth="md">
          ...
          <Typography
            ...
            sx={{ mb: 4 }}
          >
            A professional kit that comes with ready-to-use analytical tools to help you grow your business
          </Typography>
          <Typography
            variant="subtitle2"
            sx={{ mb: 2 }}
...
AuthStyleLayout.propTypes = {
  children: PropTypes.node,
};

export default AuthStyleLayout;
