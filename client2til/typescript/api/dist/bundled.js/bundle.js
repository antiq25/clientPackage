...
const authAPI = {
  ...
  fetchProfile: () => apiCall("fetchProfile", () => apiClient.get(authAPIEndpoints.fetchProfile), "Profile fetched", "Fetching profile failed"),
...
export { apiCall, apiClient as apiConfig, apiWrap as apiHandler, authAPI, authAPIEndpoints, generateMessage, showErrorMessage, showSuccessMessage };
